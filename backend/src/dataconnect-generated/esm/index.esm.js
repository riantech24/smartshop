...
export const listMyNotesRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
...
export function listMyNotes(dcOrOptions, options) {
...
export function listMyWorkspaces(dcOrOptions, options) {
